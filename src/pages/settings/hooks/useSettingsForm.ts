...
export function useSettingsForm() {
  ...
  const form = useForm<SettingsFormValues>({
    ...
    defaultValues: {
      ...
      reschedule_template: (userSettings as any)?.reschedule_template || "",
      cancellation_template: (userSettings as any)?.cancellation_template || "",
      questionnaire_template: (userSettings as any)?.questionnaire_template || "",
