...
export function useSettingsForm() {
  ...
  const form = useForm<SettingsFormValues>({
    ...
    defaultValues: {
      ...
      reschedule_template: userSettings?.reschedule_template || "",
      cancellation_template: userSettings?.cancellation_template || "",
      questionnaire_template: userSettings?.questionnaire_template || "",
